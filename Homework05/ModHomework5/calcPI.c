...
int main(int argc, char** argv) {
   ...
   int id, numProcesses, start, stop = -1;
   int chunkSize1, chunkSize2, remainder;
   ...
   chunkSize1 = (int)ceil((double)numTrapezoids / numProcesses);
   ...
   localApproximatePI = integrateTrap(start, stop, stop-start) * 4;
